...
function wrapInTagsAndSelect(editor) {
    return __awaiter(this, void 0, void 0, function* () {
        const tagsMissingElements = yield wrapInEmptyTags(editor);
        yield selectAndAddTags(editor, tagsMissingElements);
    });
}
exports.wrapInTagsAndSelect = wrapInTagsAndSelect;
function wrapInEmptyTags(editor) {
    return __awaiter(this, void 0, void 0, function* () {
...
function selectAndAddTags(editor, tagsMissingElements) {
    return __awaiter(this, void 0, void 0, function* () {
        const tabSizeSpace = (0, utilities_1.getTabString)(editor);
