...
- fix(shell): Fixed launching shell with SSH connections (VSCODE-327, [#402](https://github.com/mongodb-js/vscode/issues/402))
...
- Exposed export to Ruby as a language in the export to language feature (VSCODE-323, [#391](https://github.com/mongodb-js/vscode/issues/391)) 
...
- Use new data service and connection model (VSCODE-297, [#377](https://github.com/mongodb-js/vscode/issues/377))
...
### Added
- Added export to language for selected query content and aggregation content in playgrounds (VSCODE-296, [#366](https://github.com/mongodb-js/vscode/issues/366))
...
- Added syntax support for new 5.1 features (VSCODE-306, VSCODE-305, VSCODE-304, VSCODE-302, [#357](https://github.com/mongodb-js/vscode/issues/357), [#359](https://github.com/mongodb-js/vscode/issues/359))

### Changed

- Updated MongoDB branding (VSCODE-297, [#358](https://github.com/mongodb-js/vscode/issues/358))

### Fixed

- Fixed opening files with special characters in their _ids (VSCODE-276, [#342](https://github.com/mongodb-js/vscode/issues/342))
...
- Replaced code lenses with code actions for partially running playgrounds (VSCODE-247, [#318](https://github.com/mongodb-js/vscode/issues/318))
- Updated the MongoDB driver to 4.1.2 and mongosh to 1.0.4 (VSCODE-270, [#337](https://github.com/mongodb-js/vscode/issues/337))
- Updated the create collection time-series template to include granularity (VSCODE-292, [#344](https://github.com/mongodb-js/vscode/issues/344))

### Fixed

- Fixed TLS/SSL files not resolving correctly when connecting with WSL(Windows Subsystem for Linux) (VSCODE-284, [#343](https://github.com/mongodb-js/vscode/issues/343))
- Fixed playgrounds not loading SSL/TLS files correctly with new MongoDB node driver (VSCODE-292, [#347](https://github.com/mongodb-js/vscode/issues/347))
...
- Removed extra newline character at the end of the link in the generated changelog (VSCODE-282, [#332](https://github.com/mongodb-js/vscode/issues/332))
- Fixed image location referencing an incorrect branch in the generated VSCode marketplace README (VSCODE-281, [#333](https://github.com/mongodb-js/vscode/issues/333))
...
- Fixed image locations in the published VSCode marketplace README resolving to an incorrect branch (VSCODE-281, [#331](https://github.com/mongodb-js/vscode/issues/331))
...
- Added support for showing databases a user has permissions to when they cannot `listDatabases` (VSCODE-157, [#317](https://github.com/mongodb-js/vscode/issues/317))
...
- Added icons for time-series collections (VSCODE-263, [#296](https://github.com/mongodb-js/vscode/issues/296))
- Updated our mongosh dependency to 1.0.0 and MongoDB node driver to a fork of the 4.0.0 driver (VSCODE-264, [#308](https://github.com/mongodb-js/vscode/issues/308))
...
- Updated how collections and databases are created to use playgrounds instead of vscode inputs (VSCODE-262, [#294](https://github.com/mongodb-js/vscode/issues/294))
- Updated how playgrounds are run to preserve focus on the editor when the results are shown (VSCODE-214, [#290](https://github.com/mongodb-js/vscode/issues/290), [#222](https://github.com/mongodb-js/vscode/issues/222))
...
- Fixed showing an error when large files are shown in vscode which have tokenization disabled (VSCODE-250, [#290](https://github.com/mongodb-js/vscode/issues/290))
- Fixed showing recently dropped collections and databases in the explorer (VSCODE-244, [#288](https://github.com/mongodb-js/vscode/issues/288))
...
- Fix launching mongodb shell with ssl in bash (VSCODE-227, [#270](https://github.com/mongodb-js/vscode/issues/270))
...
- Fixed an issue with playground connectivity not defaulting the `directConnection` option to true (VSCODE-234, [#255](https://github.com/mongodb-js/vscode/issues/255))
- Fixed an issue around showing an error while editing a playground file without an active MongoDB connection (VSCODE-231, [#251](https://github.com/mongodb-js/vscode/issues/251))
...
- Added the ability to edit documents opened from the explorer panel (VSCODE-219, [#226](https://github.com/mongodb-js/vscode/issues/226), [#239](https://github.com/mongodb-js/vscode/issues/239))
- Added the ability to open and edit documents from playground results (VSCODE-222, [#232](https://github.com/mongodb-js/vscode/issues/232))
- Added icons for connect and playground panel actions (VSCODE-179, [#240](https://github.com/mongodb-js/vscode/issues/240))
- Added the ability to specify multiple hosts and ports in the connection form (VSCODE-208, [#224](https://github.com/mongodb-js/vscode/issues/224))
- Added a feature where we show the overview page when the extension is first installed (VSCODE-167, [#225](https://github.com/mongodb-js/vscode/issues/225))

### Changed

- Changed how we generate default connection names for new connections to better represent multiple hosts and ports, and srv records (VSCODE-221, [#227](https://github.com/mongodb-js/vscode/issues/227))
- Changed how we show connectivity errors with the connection form (VSCODE-196, [#217](https://github.com/mongodb-js/vscode/issues/217))

### Fixed

- Fix opening documents with a binary `_id` from the explorer panel (VSCODE-118, [#220](https://github.com/mongodb-js/vscode/issues/220))
...
- Fixed code lenses for partial playground executions sometimes being missing (VSCODE-226, [#243](https://github.com/mongodb-js/vscode/issues/243))
